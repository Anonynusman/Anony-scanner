...
def scan():
        ...
        print(" ╚═╝░░╚═╝╚═╝░░╚══╝░╚════╝░╚═╝░░╚══╝░░░╚═╝░░░")
        print("")
        print("𓂀 𝔸 𝕥𝕠𝕠𝕝 𝕔𝕠𝕕𝕖𝕕 𝕓𝕪 𝕆𝕤𝕞𝕒𝕟 𝕄𝕠𝕙𝕒𝕞𝕞𝕖𝕕  ")
        print("(人◕‿◕) 𝔸.𝕂.𝔸 𝔸𝕟𝕠𝕟𝕪𝕟𝕦𝕤𝕞𝕒𝕟 (•◡•)𓂀 ) ")
        print("𓂀 𝔽𝕠𝕝𝕝𝕠𝕨 𝕒𝕟𝕕 𝕤𝕥𝕒𝕣 𝕞𝕪 𝕣𝕖𝕡𝕠 𝕒𝕥 𝕙𝕥𝕥𝕡𝕤://𝕘𝕚𝕥𝕙𝕦𝕓.𝕔𝕠𝕞/𝔸𝕟𝕠𝕟𝕪𝕟𝕦𝕤𝕞𝕒𝕟 𓂀 ") 
        print(" v1.0")
	print("") 
	print(" Anony-scanner - Pentest the Modern Web")
	print("")
	def menu():
